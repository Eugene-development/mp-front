...
<section id="catalog" class="border-y border-brand-divider bg-white/40 py-24">
	<div class="mx-auto max-w-[1440px] px-4">
		...
		<div class="grid grid-cols-1 items-stretch gap-8 md:grid-cols-12">
			...
			<!-- Bento Item 2: Buckets with Lid (Tall - col-span-4) -->
			...
			<!-- Bento Item 3: Canisters, Jars and Tubes (Tall/Grid - col-span-5) -->
						...
						<div>
							<div class="mb-4 flex items-center justify-between">
								<span
									...
									>В наличии</span
								>
								<span class="font-mono text-[9px] text-brand-gray">Широкий спектр</span>
							</div>
			...
			<!-- Bento Item 4: Eurocubes (Wide/Grid - col-span-7) -->
