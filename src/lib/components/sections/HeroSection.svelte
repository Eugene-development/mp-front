...
<section id="home" class="relative w-full overflow-hidden">
	...
	<div class="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
		...
		>
			...
			<path
				d="M -100,200 C 300,100 500,600 800,450 C 1100,300 1200,700 1700,500"
				stroke="var(--color-brand-accent)"
				stroke-width="1.25"
			/>
			<path
				d="M -100,230 C 300,130 500,630 800,480 C 1100,330 1200,730 1700,530"
				stroke="var(--color-brand-accent)"
				stroke-width="0.75"
				stroke-dasharray="4 4"
			/>
			<path
				d="M -100,260 C 300,160 500,660 800,510 C 1100,360 1200,760 1700,560"
				stroke="var(--color-brand-accent)"
				stroke-width="1"
			/>
			<path
				d="M -100,290 C 300,190 500,690 800,540 C 1100,390 1200,790 1700,590"
				stroke="var(--color-brand-accent)"
				stroke-width="0.5"
			/>
			<path
				d="M -100,320 C 300,220 500,720 800,570 C 1100,420 1200,820 1700,620"
				stroke="var(--color-brand-accent)"
				stroke-width="0.75"
			...
			<path
				d="M -100,700 C 400,650 500,150 900,200 C 1300,250 1250,50 1700,-50"
				stroke="var(--color-brand-dark)"
				stroke-width="1"
			/>
			<path
				d="M -100,730 C 400,680 500,180 900,230 C 1300,280 1250,80 1700,-20"
				stroke="var(--color-brand-dark)"
				stroke-width="0.5"
				stroke-dasharray="6 3"
			/>
			<path
				d="M -100,760 C 400,710 500,210 900,260 C 1300,310 1250,110 1700,10"
				stroke="var(--color-brand-dark)"
				stroke-width="0.75"
			/>
			<path
				d="M -100,790 C 400,740 500,240 900,290 C 1300,340 1250,140 1700,40"
				stroke="var(--color-brand-dark)"
				stroke-width="0.5"
			/>
					...
					>
						...
						<div class="relative z-10 grid grid-cols-2 gap-4 border-t border-brand-divider pt-4">
							<div class="flex items-center gap-2">
								...
								<div class="flex flex-col">
									<span class="text-[8px] tracking-wider text-brand-gray uppercase"
										>Материал колбы</span
									>
